...
The next step is to find the number in the middle of the array. If the array has an odd number of elements, the median is the number in the middle of the array. If the array has an even number of elements, the median is the mean of the two middle numbers.
